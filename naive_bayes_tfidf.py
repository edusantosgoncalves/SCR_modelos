...
vectorizer_sem_limp = TfidfVectorizer()
...
nb_classifier_sem_limp = MultinomialNB()
nb_classifier_sem_limp.fit(X_train_vectorized_sem_limp, y_train_sem_limp)

# Avaliar o modelo
y_pred_sem_limp = nb_classifier_sem_limp.predict(X_test_vectorized_sem_limp)
...
# Treinar o modelo Naive Bayes
nb_classifier_c_limp_parc = MultinomialNB()
nb_classifier_c_limp_parc.fit(X_train_vectorized_c_limp_parc, y_train_c_limp_parc)

# Avaliar o modelo
y_pred_c_limp_parc = nb_classifier_c_limp_parc.predict(X_test_vectorized_c_limp_parc)
...
# Vetorização dos dados de texto
vectorizer_c_limp = TfidfVectorizer()
...
# Treinar o modelo Naive Bayes
nb_classifier_c_limp = MultinomialNB()
nb_classifier_c_limp.fit(X_train_vectorized_c_limp, y_train_c_limp)

# Avaliar o modelo
y_pred_c_limp = nb_classifier_c_limp.predict(X_test_vectorized_c_limp)
